...
class PairPrinter:
    ...
    def __init__(self):
        ...
        self.alignment = "/proj/nlpl/data/OPUS/" + self.args.d + "/" + self.args.r + "/xml/" + self.fromto[0] + "-" + \
                         self.fromto[1] + ".xml.gz"
        self.source = "/proj/nlpl/data/OPUS/" + self.args.d + "/" + self.args.r + "/" + self.args.p + "/" + self.fromto[
            0] + ".zip"
        self.target = "/proj/nlpl/data/OPUS/" + self.args.d + "/" + self.args.r + "/" + self.args.p + "/" + self.fromto[
            1] + ".zip"
        self.moses = "/proj/nlpl/data/OPUS/" + self.args.d + "/" + self.args.r + "/moses/" + self.fromto[0] + "-" + \
                     self.fromto[1] + ".txt.zip"
